...
const saveCar = async (req: NextApiRequest, res: NextApiResponse) => {
    const { brand, model, year, description, category, price, imageFormat, imageData } = req.body;
	...
	const newCar: carType = { brand, model, year, img, description, category, price: parseFloat(price)};
